...
import { useUserSettingsRouting } from "../hooks";
import state from "mattermost-redux/store/initial_state";
import UserProfile from "components/user_profile/user_profile";
import GenricSectionCreator1 from "../genric_section_creator1";
...
const UserSettingsNotifications: FC<Props> = (props: Props) => {
    ...
    const getNotificationsStateFromProps = () => {
        // const { user } = useUserSettingsRouting();
        console.log(user);
    ...
    const sameAsDesktop = UseSameAsDesktop === "true" ? true : false;
    return (
            ...
            {GenricSectionCreator1({
                ...
                xtraInfo: (
                    <div className="Pb-24">
                        ...
                        <select
                            value={
                                PushStatus === Constants.UserStatuses.ONLINE
                                    ? NOTIFICATION_CONSTANTS.ONLINE
                                    : PushStatus ===
                                      Constants.UserStatuses.OFFLINE
                                    ? NOTIFICATION_CONSTANTS.OFFLINE
                                    : NOTIFICATION_CONSTANTS.AWAY
                            }
