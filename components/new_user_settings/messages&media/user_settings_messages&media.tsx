...
import UserSettingsNotificationsPure from '../notifications/notifications_pure';
import './user_settings_messages&media.scss';
import GenricSectionCreator from '../genric_section_creator';
...
const UserSettingsMessagesAndMedia: FC<Props> = (props: Props) => {
    return (
